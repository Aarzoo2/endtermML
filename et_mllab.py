...
Original file is located at
    https://colab.research.google.com/drive/1iFUITm2ukAHJJ7cirBTA1cIlq-SDOHr5
...
dataset= pd.read_csv('/content/Classification Dataset11.csv - Classification Dataset11.csv.csv')
print(dataset)
...
saved_model=pickle.dump(classifier,open('/content/Classification Dataset11.csv', 'wb')) 
# Saving model to disk

# Load the pickled model 
model = pickle.load(open('/content/Classification Dataset11.csv','rb'))  
# Use the loaded pickled model to make predictions 
model.predict(X_test)

# save the model to disk
import joblib
filename = '/content/Classification Dataset11.sav'
...
import pickle
import pandas as pd
dataset= pd.read_excel('/content/Classification Dataset 11.xlsx')
X = dataset.iloc[:, 0:8].values
from sklearn.preprocessing import StandardScaler
sc = StandardScaler()
